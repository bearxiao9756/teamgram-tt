...
export const PRODUCTION_HOSTNAME = 'webim.customgoodservice.icu';
export const PRODUCTION_URL = 'https://webim.customgoodservice.icu/a';
export const WEB_VERSION_BASE = 'https://webim.customgoodservice.icu/'; // Used to redirect to other versions
